    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-[400px] p-0 overflow-hidden border-none shadow-2xl">
        <div className="bg-primary p-8 text-primary-foreground text-center space-y-2">
          ...
          <DialogTitle className="text-2xl font-headline font-bold">Welcome Back</DialogTitle>
          <DialogDescription className="text-primary-foreground/80">
            Join the SRMU Lucknow student marketplace.
          </DialogDescription>
        </div>
        ...
        <div className="p-8 space-y-6 bg-white">
          <div className="space-y-4">
            <Button 
              ...
              variant="outline" 
              className="w-full h-12 gap-3 text-lg font-medium border-2 hover:bg-secondary/20 transition-all"
              disabled={isLoading}
            >
              {isLoading ? (
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-muted-foreground">Student Only</span>
            </div>
          </div>
